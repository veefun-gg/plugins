    ...
    $content = '<section class="related-cards" data-related-cards aria-labelledby="'.esc_attr($heading_id).'">';
        $content .= '<div class="related-cards__header">';
            ...
            $content .= '<div class="related-cards__controls" data-related-cards-controls hidden>';
                $content .= '<button class="related-cards__control related-cards__control--prev" type="button" data-related-cards-prev aria-controls="'.esc_attr($viewport_id).'" aria-label="Show previous related card" disabled>';
                    $content .= '<span aria-hidden="true">&larr;</span>';
                $content .= '</button>';
                $content .= '<button class="related-cards__control related-cards__control--next" type="button" data-related-cards-next aria-controls="'.esc_attr($viewport_id).'" aria-label="Show next related card" disabled>';
